...
def register_file_exchange_fetcher(
    ...
    async def _consume_transfer(handle: TransferHandle) -> None:
        ...
        Selects a source descriptor and dispatches to the per-transport
        fetcher. Generated by ``register_file_exchange_fetcher``.
        """
...
def register_file_exchange_sender(
    ...
    async def _send_to_receiver(ticket: IntakeTicket, key: str) -> None:
        ...
        Selects a sink descriptor and dispatches to the per-transport
        sender. Generated by ``register_file_exchange_sender``.
        """
